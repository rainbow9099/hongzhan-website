  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-dark-900">
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?auto=format&fit=crop&w=1920&q=80')`,
        }}
      />
      ...
      <div className="relative z-10 container-custom text-center text-white py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-brand-400 font-semibold tracking-widest uppercase mb-4 animate-fade-in">
            {t('hero.badge')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up">
            ...
            <a href="#oem" className="btn-secondary text-base">
              {t('hero.startProject')}
            </a>
            <a
